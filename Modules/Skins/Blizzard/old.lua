local Core = Phoenix_UI:NewModule("Skins.Core");
...
function Core:OnEnable()
	...
	if (db and color) then
		...
		-- Raidframe
		local Phoenix_UI = CreateFrame("Frame")
		Phoenix_UI:RegisterEvent("PLAYER_ENTERING_WORLD")
		Phoenix_UI:RegisterEvent("GROUP_ROSTER_UPDATE")
		...
		Phoenix_UI:SetScript("OnEvent", function(self, event)
			ColorRaid()
		...
		CompactRaidFrameManagerToggleButton:SetNormalTexture("Interface\\Phoenix_UI\\Media\\Textures\\RaidFrames\\RaidPanel-Toggle")
		for i = 1, 4 do
