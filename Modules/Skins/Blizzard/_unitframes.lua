local Module = Phoenix_UI:NewModule("Skins.UnitFrames");
...
function Module:OnEnable()
    if (Phoenix_UI:Color()) then
        ...
        PlayerFrame:HookScript("OnUpdate", function()
            PlayerFrame.PlayerFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            PlayerFrame.PlayerFrameContent.PlayerFrameContentContextual.PlayerPortraitCornerIcon:SetVertexColor(unpack(
                Phoenix_UI:Color(0.15)))
            PlayerFrame.PlayerFrameContainer.AlternatePowerFrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
        end)

        -- Pet Frame
        PetFrame:HookScript("OnUpdate", function()
            PetFrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
        end)

        -- Target Frame
        TargetFrame:HookScript("OnUpdate", function()
            TargetFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            TargetFrameToT.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
        end)

        -- Focus Frame
        FocusFrame:HookScript("OnUpdate", function()
            FocusFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            FocusFrameToT.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
        end)

        BossTargetFrameContainer:HookScript("OnUpdate", function()
            Boss1TargetFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            Boss2TargetFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            Boss3TargetFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            Boss4TargetFrame.TargetFrameContainer.FrameTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
        end)

        -- Totem Bar
        TotemFrame:HookScript("OnEvent", function(self)
            for totem, _ in self.totemPool:EnumerateActive() do
                totem.Border:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
            end
        end)
        ...
        if (playerClass == 'ROGUE') then
            ...
            hooksecurefunc(RogueComboPointBarFrame, "UpdatePower", function()
                for bar, _ in RogueComboPointBarFrame.classResourceButtonPool:EnumerateActive() do
                    bar.BGActive:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.BGInactive:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.BGShadow:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    if (bar.isCharged) then
                        bar.ChargedFrameActive:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    end
                end
        ...
        elseif (playerClass == 'MAGE') then
            ...
            hooksecurefunc(MagePowerBar, "UpdatePower", function()
                for bar, _ in MageArcaneChargesFrame.classResourceButtonPool:EnumerateActive() do
                    bar.ArcaneBG:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.ArcaneBGShadow:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                end
        ...
        elseif (playerClass == 'WARLOCK') then
            ...
            hooksecurefunc(WarlockPowerFrame, "UpdatePower", function()
                for bar, _ in WarlockPowerFrame.classResourceButtonPool:EnumerateActive() do
                    bar.Background:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                end
        ...
        elseif (playerClass == 'DRUID') then
            ...
            hooksecurefunc(DruidComboPointBarFrame, "UpdatePower", function()
                for bar, _ in DruidComboPointBarFrame.classResourceButtonPool:EnumerateActive() do
                    bar.BG_Active:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.BG_Inactive:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.BG_Shadow:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                end
        ...
        elseif (playerClass == 'MONK') then
            ...
            hooksecurefunc(MonkHarmonyBarFrame, "UpdatePower", function()
                for bar, _ in MonkHarmonyBarFrame.classResourceButtonPool:EnumerateActive() do
                    bar.Chi_BG:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.Chi_BG_Active:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                end
        ...
        elseif (playerClass == 'EVOKER') then
            ...
            hooksecurefunc(EssencePlayerFrame, "UpdatePower", function()
                for bar, _ in EssencePlayerFrame.classResourceButtonPool:EnumerateActive() do
                    bar.EssenceFillDone.CircBG:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                    bar.EssenceFillDone.CircBGActive:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                end
        ...
        elseif (playerClass == 'PALADIN') then
            ...
            hooksecurefunc(PaladinPowerBar, "UpdatePower", function()
                PaladinPowerBarFrame.Background:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
                PaladinPowerBarFrame.ActiveTexture:Hide()
                ClassNameplateBarPaladinFrame.Background:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
