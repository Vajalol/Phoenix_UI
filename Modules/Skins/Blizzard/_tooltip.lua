local Module = Phoenix_UI:NewModule("Skins.Tooltip");
            ...
            if (self.NineSlice) then
                ...
                if itemLink then
                    ...
                    if itemRarity and itemRarity >= 2 then
                        ...
                        self.NineSlice:SetBorderColor(unpack(Phoenix_UI:Color(0.15)))
                    end
                end
            end
        end
