local Module = Phoenix_UI:NewModule("ActionBars.Mouseover");
...
function Module:OnEnable()
    ...
    local db = {
        bars = Phoenix_UI.db.profile.actionbar.bars,
        micromenu = Phoenix_UI.db.profile.actionbar.menu.micromenu,
        bagbar = Phoenix_UI.db.profile.actionbar.menu.bagbar,
