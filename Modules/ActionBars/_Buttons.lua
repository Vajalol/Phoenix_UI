local Module = Phoenix_UI:NewModule("ActionBars.Buttons");
...
function Module:OnEnable()
    ...
    if (Phoenix_UI:Color()) then
        ...
        local db = { 
            buttons = Phoenix_UI.db.profile.actionbar.buttons,
            menu = Phoenix_UI.db.profile.actionbar.menu
        }
        ...
        local function StyleButton(Button, Type)
            ...
            if Button.Shadow == nil then
                ...
                NormalTexture:SetVertexColor(unpack(Phoenix_UI:Color(0.15)))
