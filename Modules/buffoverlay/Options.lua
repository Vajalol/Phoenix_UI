...
-- Use the localization table that was set up in Init.lua
local L = BuffOverlay.L

local LibDD = LibStub:GetLibrary("LibUIDropDownMenu-4.0", true) or {}
local bit = bit

-- Create a safe version string that won't error
local version = "11.0.42" -- Use the version from Phoenix_UI.toc
    ...
    self.options = {
        ...
        args = {
            logo = {
                ...
                type = "description",
                name = function()
                    -- Safe way to get author metadata
                    local author = "Unknown"
                    if C_AddOns and C_AddOns.GetAddOnMetadata then
                        author = C_AddOns.GetAddOnMetadata("BuffOverlay", "Author") or author
                    elseif GetAddOnMetadata then
                        author = GetAddOnMetadata("BuffOverlay", "Author") or author
                    end
                    
                    return self:Colorize(L["Author"]) .. ": " .. author .. 
