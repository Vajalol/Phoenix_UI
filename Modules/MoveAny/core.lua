...
-- Add MClamp function
function MoveAny:MClamp(value, min, max)
	if value < min then
		return min
...
function MoveAny:GetCVar(name)
	-- Use the global GetCVar function to safely get CVars
	return GetCVar and GetCVar(name) or "1"
end
