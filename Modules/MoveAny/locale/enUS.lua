...
-- Define L at the beginning with a metatable for safe access and updates
local L = setmetatable({}, {
	__index = function(t, k)
		return k
	end,
	__newindex = function(t, k, v)
		if MoveAny.AddTrans then
			MoveAny:AddTrans("enUS", k, v)
		end
	end
})
...
function MoveAny:LangenUS()
	local tab = {
		...
		["LID_STARTHELP"] = "",
		["LID_STARTHELP2"] = "Or type /move in chat to open the settings.",
		...
		["LID_SHARESHARESETTINGS"] = "Share Settings",
		["LID_SHOWSCALE"] = "Scale",
		["LID_STACKSPERLINE"] = "Stacks per line",
		["LID_STANDART"] = "Standard",
		["LID_STATEDURATION"] = "State: Duration",
	}
...
-- Apply localizations directly to the language table
L["MoveAny Icon Style"] = true
L["MoveAny Icon Theme"] = true
-- L["MoveAny Icon on Minimap Avalable."] = true
L["Moving"] = true
