...
local function UpdateRegisteredEvents()
	...
	-- Add safety check for currentProfile
	if MSBTProfiles.currentProfile and MSBTProfiles.currentProfile.events and 
	   MSBTProfiles.currentProfile.events.NOTIFICATION_COOLDOWN and 
	   (not MSBTProfiles.currentProfile.events.NOTIFICATION_COOLDOWN.disabled or MSBTTriggers.categorizedTriggers["SKILL_COOLDOWN"]) then
		doEnable = true
	end
	...
	-- Add safety check for currentProfile
	if MSBTProfiles.currentProfile and MSBTProfiles.currentProfile.events and 
	   MSBTProfiles.currentProfile.events.NOTIFICATION_PET_COOLDOWN and
	   (not MSBTProfiles.currentProfile.events.NOTIFICATION_PET_COOLDOWN.disabled or MSBTTriggers.categorizedTriggers["PET_COOLDOWN"]) then
		doEnable = true
	end
	...
	-- Add safety check for currentProfile
	if MSBTProfiles.currentProfile and MSBTProfiles.currentProfile.events and 
	   MSBTProfiles.currentProfile.events.NOTIFICATION_ITEM_COOLDOWN and
	   (not MSBTProfiles.currentProfile.events.NOTIFICATION_ITEM_COOLDOWN.disabled or MSBTTriggers.categorizedTriggers["ITEM_COOLDOWN"]) then
		doEnable = true
	end
