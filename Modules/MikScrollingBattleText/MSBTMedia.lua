...
local function OnVariablesInitialized()
	-- Make sure MSBTProfiles and savedMedia exist and are properly initialized
	if not MSBTProfiles or not MSBTProfiles.savedMedia then
		return
	end
	
	-- Make sure fonts and sounds tables exist before iterating
	if MSBTProfiles.savedMedia.fonts then
	...
	if MSBTProfiles.savedMedia.sounds then
