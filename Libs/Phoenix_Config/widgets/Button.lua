...
local SquareButtonMethods = {
	SetIconDisabled = function(self, texture, iconWidth, iconHeight)
		self.iconDisabled = self.Phoenix_UIConfig:Texture(self, iconWidth, iconHeight, texture);
	...
	SetIcon = function(self, texture, iconWidth, iconHeight, alsoDisabled)
		self.icon = self.Phoenix_UIConfig:Texture(self, iconWidth, iconHeight, texture);
...
function Phoenix_UIConfig:SquareButton(parent, width, height, icon)
...
function Phoenix_UIConfig:ButtonLabel(parent, text)
...
function Phoenix_UIConfig:HighlightButtonTexture(button)
...
--- @return Button
function Phoenix_UIConfig:HighlightButton(parent, width, height, text, inherit)
...
--- @return Button
function Phoenix_UIConfig:Button(parent, width, height, text, inherit)
...
function Phoenix_UIConfig:ButtonAutoWidth(button, padding)
