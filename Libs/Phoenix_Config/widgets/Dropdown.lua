...
local dropdowns = Phoenix_UIConfigDropdowns or {};
Phoenix_UIConfigDropdowns = dropdowns;
...
local DropdownMethods = {
	buttonCreate = function(parent)
		...
		if dropdown.multi then
			optionButton = dropdown.Phoenix_UIConfig:Checkbox(parent, '', parent:GetWidth(), 20);
		else
			optionButton = dropdown.Phoenix_UIConfig:HighlightButton(parent, parent:GetWidth(), 20, '');
...
--- }
--- @return Dropdown
function Phoenix_UIConfig:Dropdown(parent, width, height, options, value, multi, assoc)
	--- @class Dropdown
	local dropdown = self:Button(parent, width, height, '');
	dropdown.Phoenix_UIConfig = self;
