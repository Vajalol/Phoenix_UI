...
--- @return FontString
function Phoenix_UIConfig:Label(parent, text, size, inherit, width, height)
...
--- @return FontString
function Phoenix_UIConfig:Header(parent, text, size, inherit, width, height)
...
--- @return FontString
function Phoenix_UIConfig:AddLabel(parent, object, text, labelPosition, labelWidth)
