...
function Phoenix_UIConfig:ObjectList(parent, itemsTable, create, update, data, padding, oX, oY, limitFn)
	local this = self;
	oX = oX or 1;
	oY = oY or -1;
...
--- @param oX number
--- @param oY number
function Phoenix_UIConfig:ObjectGrid(parent, itemsMatrix, create, update, data, paddingX, paddingY, oX, oY)
	oX = oX or 1;
	oY = oY or -1;
